    ...
    static class Tab_Settings
    {
        ...
        public static void Put_in_class()
        {
            ...
            foreach (string tab in tabs_from_file.Keys)
            {
                ...
                {
                    Tab_products tb = new Tab_products(t.Get_name(), f["id"], f["name"], f["type"], f["brand_id"], f["cost"], f["image"]);                    
                    tabs.Add(Tab_names.product.ToString(), tb);
                }
                else if (tab.Equals(Tab_names.users.ToString()))
                {
                    Tab_users tb = new Tab_users(t.Get_name(), f["id"], f["FIO"], f["login"], f["password"], f["email"], f["settings"]);
                    tabs.Add(Tab_names.users.ToString(), tb);
                }
                else if (tab.Equals(Tab_names.brands.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.brands.ToString(), tb);
                }
                else if (tab.Equals(Tab_names.checks.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.checks.ToString(), tb);
                }
                else if (tab.Equals(Tab_names.customers.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.customers.ToString(), tb);
                }
                ...
                else if (tab.Equals(Tab_names.product_on_store.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.product_on_store.ToString(), tb);
                }
                else if (tab.Equals(Tab_names.product_type_big.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.product_type_big.ToString(), tb);
                }
                else if (tab.Equals(Tab_names.product_type_little.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.product_type_little.ToString(), tb);
                }
                else if (tab.Equals(Tab_names.promo_full.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.promo_full.ToString(), tb);
                }
                else if (tab.Equals(Tab_names.promo_history.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.promo_history.ToString(), tb);
                }
                ...
                else if (tab.Equals(Tab_names.type_group.ToString()))
                {
                    ...
                    tabs.Add(Tab_names.type_group.ToString(), tb);
                }
